...
![Version: 0.18.2](https://img.shields.io/badge/Version-0.18.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.0.80917](https://img.shields.io/badge/AppVersion-1.0.80917-informational?style=flat-square)
...
docker.io/chaosnative/harness-chaos-log-watcher:1.38.0
docker.io/chaosnative/source-probe:ci
docker.io/curlimages/curl:8.7.1
docker.io/haproxy:lts-alpine3.18
docker.io/harness/accesscontrol-service-signed:1.48.3
docker.io/harness/argocd:v2.9.4
docker.io/harness/audit-event-streaming-signed:1.4.1
docker.io/harness/batch-processing-signed:1.19.2
docker.io/harness/ccm-gcp-smp-signed:10057
docker.io/harness/cdcdata-signed:1.18.0
docker.io/harness/ce-anomaly-detection-signed:1.1.0
docker.io/harness/ce-cloud-info-signed:1.3.2
docker.io/harness/ce-nextgen-signed:1.20.5
docker.io/harness/chaos-argoexec:v3.4.16
docker.io/harness/chaos-ddcr:1.38.0
docker.io/harness/chaos-exporter:1.38.0
docker.io/harness/chaos-go-runner-base:1.38.1
docker.io/harness/chaos-go-runner-io:1.38.1
docker.io/harness/chaos-go-runner-time:1.38.1
docker.io/harness/chaos-go-runner:1.38.1
docker.io/harness/chaos-k8s:1.38.0
docker.io/harness/chaos-log-watcher:1.38.0
docker.io/harness/chaos-machine-ifc-signed:1.38.0
docker.io/harness/chaos-machine-ifs-signed:1.38.0
docker.io/harness/chaos-operator:1.38.0
docker.io/harness/chaos-runner:1.38.1
docker.io/harness/chaos-subscriber:1.38.1
docker.io/harness/chaos-workflow-controller:v3.4.16
docker.io/harness/ci-manager-signed:1.30.4
docker.io/harness/ci-scm-signed:1.4.3
docker.io/harness/cv-nextgen-signed:1.21.1
docker.io/harness/dashboard-service-signed:1.65.0
...
docker.io/harness/delegate:24.07.83205
docker.io/harness/delegate:24.07.83205.minimal
...
docker.io/harness/gateway-signed:1.28.0
docker.io/harness/gitops-agent-installer-helper:v0.0.1
docker.io/harness/gitops-agent:v0.74.1
docker.io/harness/gitops-service-signed:1.11.8
docker.io/harness/helm-init-container:latest
docker.io/harness/k8s-chaos-infrastructure-upgrader:1.38.0
docker.io/harness/le-nextgen-signed:1.3.0
docker.io/harness/learning-engine-onprem-signed:1.1.0
docker.io/harness/litmus-checker:1.38.0
docker.io/harness/log-service-signed:1.6.1
docker.io/harness/looker-signed:1.1.0
docker.io/harness/manager-signed:1.32.10
docker.io/harness/migrator-signed:1.83.0
docker.io/harness/nextgenui-signed:1.26.17
docker.io/harness/ng-auth-ui-signed:1.24.2
docker.io/harness/ng-ce-ui:1.18.2
docker.io/harness/ng-dashboard-aggregator-signed:1.21.0
docker.io/harness/ng-manager-signed:1.41.11
docker.io/harness/pipeline-service-signed:1.78.8
docker.io/harness/platform-service-signed:1.26.3
docker.io/harness/policy-mgmt:1.5.1
docker.io/harness/queue-service-signed:1.2.0
docker.io/harness/service-discovery-collector:0.18.0
docker.io/harness/service-discovery-k8s-lifecycle-agent:0.18.0
docker.io/harness/smp-chaos-bg-processor-signed:1.38.16
docker.io/harness/smp-chaos-db-upgrade-agent-signed:1.38.16
docker.io/harness/smp-chaos-k8s-ifs-signed:1.38.4
docker.io/harness/smp-chaos-linux-infra-controller-signed:1.38.0
docker.io/harness/smp-chaos-linux-infra-server-signed:1.38.0
docker.io/harness/smp-chaos-manager-signed:1.38.16
docker.io/harness/smp-chaos-web-signed:1.38.7
docker.io/harness/smp-service-discovery-server-signed:0.18.0
docker.io/harness/srm-ui-signed:1.5.0
docker.io/harness/ssca-manager-signed:1.11.3
docker.io/harness/ssca-ui-signed:0.8.0
docker.io/harness/stocore-signed:1.97.2
docker.io/harness/stomanager-signed:1.29.2
docker.io/harness/telescopes-signed:1.1.0
docker.io/harness/template-service-signed:1.41.1
docker.io/harness/ti-service-signed:1.17.0
docker.io/harness/ti-service-signed:release-223
docker.io/harness/ui-signed:1.22.0
docker.io/harness/upgrader:latest
docker.io/harness/verification-service-signed:1.32.0
...
harness/ci-addon:1.16.50
harness/ci-lite-engine:1.16.50
harness/drone-git:1.5.4-rootless
...
plugins/cache:1.6.15
plugins/gcs:1.5.4
plugins/kaniko-acr:1.8.10
plugins/kaniko-ecr:1.8.10
plugins/kaniko-gcr:1.8.10
plugins/kaniko:1.8.10
plugins/s3:1.3.2
...
| platform.harness-manager | object | `{"affinity":{},"featureFlags":{"ADDITIONAL":""},"nodeSelector":{},"tolerations":[]}` | harness-manager (taints, tolerations, and so on) |
