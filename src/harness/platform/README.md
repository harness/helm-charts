...
| change-data-capture.image.tag | string | `"77621"` |  |
...
| cv-nextgen.image.tag | string | `"77621"` |  |
...
| harness-manager.image.tag | string | `"77621"` |  |
...
| harness-manager.version | string | `"1.0.77621"` |  |
...
| next-gen-ui.image.tag | string | `"0.331.15"` |  |
...
| ng-manager.image.tag | string | `"77621"` |  |
...
| template-service.image.tag | string | `"77621"` |  |
