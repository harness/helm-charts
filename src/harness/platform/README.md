...
| change-data-capture.image.tag | string | `"76519"` |  |
...
| cv-nextgen.image.tag | string | `"76519"` |  |
...
| delegate-proxy.image.tag | string | `"76518"` |  |
...
| harness-manager.image.tag | string | `"76519"` |  |
...
| harness-manager.version | string | `"1.0.76519"` |  |
...
| next-gen-ui.image.tag | string | `"0.317.7"` |  |
...
| ng-manager.image.tag | string | `"76519"` |  |
...
| pipeline-service.image.tag | string | `"1.5.0"` |  |
...
| template-service.image.tag | string | `"76519"` |  |
...
| ti-service.image.tag | string | `"release-85"` |  |
...
| ti-service.jobs.migrate.image.tag | string | `"release-85"` |  |
