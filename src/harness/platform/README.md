...
| change-data-capture.image.tag | string | `"77123"` |  |
...
| cv-nextgen.image.tag | string | `"77123"` |  |
...
| delegate-proxy.image.tag | string | `"77033"` |  |
...
| harness-manager.image.tag | string | `"77123"` |  |
...
| harness-manager.version | string | `"1.0.77123"` |  |
...
| ng-manager.image.tag | string | `"77123"` |  |
...
| template-service.image.tag | string | `"77123"` |  |
