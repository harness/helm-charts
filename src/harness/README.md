...
![Version: 0.29.1](https://img.shields.io/badge/Version-0.29.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.0.80917](https://img.shields.io/badge/AppVersion-1.0.80917-informational?style=flat-square)
...
docker.io/harness/accesscontrol-service-signed:1.87.1
docker.io/harness/argocd:v2.13.5
docker.io/harness/audit-event-streaming-signed:1.34.0
docker.io/harness/batch-processing-signed:1.48.2
docker.io/harness/ccm-gcp-smp-signed:100039
docker.io/harness/cdcdata-signed:1.44.0
docker.io/harness/ce-anomaly-detection-signed:1.10.0
docker.io/harness/ce-cloud-info-signed:1.9.0
docker.io/harness/ce-nextgen-signed:1.51.4
docker.io/harness/chaos-argoexec:v3.4.16
docker.io/harness/chaos-ddcr-faults:1.59.1
docker.io/harness/chaos-ddcr:1.59.0
docker.io/harness/chaos-exporter:1.59.0
docker.io/harness/chaos-go-runner-base:1.59.1
docker.io/harness/chaos-go-runner-io:1.59.1
docker.io/harness/chaos-go-runner-time:1.59.1
docker.io/harness/chaos-go-runner:1.59.1
docker.io/harness/chaos-log-watcher:1.59.0
docker.io/harness/chaos-machine-ifc-signed:1.59.0
docker.io/harness/chaos-machine-ifs-signed:1.59.0
docker.io/harness/chaos-operator:1.59.0
docker.io/harness/chaos-runner:1.59.0
docker.io/harness/chaos-subscriber:1.59.0
docker.io/harness/chaos-workflow-controller:v3.4.16
docker.io/harness/ci-manager-signed:1.79.1
docker.io/harness/ci-scm-signed:1.31.0
docker.io/harness/code-api-signed:1.41.1
docker.io/harness/code-githa-signed:1.41.0
docker.io/harness/code-gitrpc-signed:1.41.0
docker.io/harness/code-search-signed:1.41.0
docker.io/harness/cv-nextgen-signed:1.37.1
docker.io/harness/dashboard-service-signed:1.80.15
docker.io/harness/db-devops-service-signed:1.40.1
docker.io/harness/debezium-service-signed:1.21.0
docker.io/harness/delegate-proxy-signed:1.1.1
docker.io/harness/delegate:25.05.85801
docker.io/harness/delegate:25.05.85801.minimal
docker.io/harness/enterprise-chaos-hub-signed:1.59.2
...
docker.io/harness/gateway-signed:1.48.1
docker.io/harness/gitops-agent-installer-helper:v0.0.3
docker.io/harness/gitops-agent:v0.93.0
docker.io/harness/gitops-service-signed:1.32.2
...
docker.io/harness/iac-server-signed:1.155.1
docker.io/harness/iacm-manager-signed:1.76.0
docker.io/harness/k8s-chaos-infrastructure-upgrader:1.59.0
...
docker.io/harness/manager-signed:1.86.4
docker.io/harness/nextgenui-signed:1.75.3
docker.io/harness/ng-auth-ui-signed:1.35.0
docker.io/harness/ng-ce-ui:1.47.1
docker.io/harness/ng-dashboard-aggregator-signed:1.52.0
docker.io/harness/ng-manager-signed:1.89.6
docker.io/harness/pipeline-service-signed:1.128.1
docker.io/harness/platform-service-signed:1.66.0
docker.io/harness/policy-mgmt:1.18.1
docker.io/harness/queue-service-signed:1.7.1
docker.io/harness/service-discovery-collector:0.39.1
docker.io/harness/smp-chaos-bg-processor-signed:1.59.2
docker.io/harness/smp-chaos-k8s-ifs-signed:1.59.2
docker.io/harness/smp-chaos-linux-infra-controller-signed:1.59.0
docker.io/harness/smp-chaos-linux-infra-server-signed:1.59.0
docker.io/harness/smp-chaos-manager-signed:1.59.2
docker.io/harness/smp-chaos-web-signed:1.59.2
docker.io/harness/smp-service-discovery-server-signed:0.39.1
docker.io/harness/source-probe:main-latest
docker.io/harness/srm-ui-signed:1.12.0
docker.io/harness/ssca-manager-signed:1.31.5
docker.io/harness/ssca-ui-signed:0.25.0
docker.io/harness/stocore-signed:1.140.1
docker.io/harness/stomanager-signed:1.64.0
docker.io/harness/telescopes-signed:1.4.0
docker.io/harness/template-service-signed:1.90.0
docker.io/harness/ti-service-signed:1.45.0
...
harness/harness-cache-server:1.7.0
...
harness/slsa-plugin:0.36.2
harness/snyk-job-runner:latest
harness/sonarqube-agent-job-runner:latest
harness/ssca-artifact-signing-plugin:0.36.1
harness/ssca-cdxgen-plugin:0.36.1
harness/ssca-compliance-plugin:0.36.2
harness/ssca-plugin:0.36.2
...
plugins/acr:20.18.8
plugins/artifactory:1.7.5
plugins/buildx-acr:1.2.16
plugins/buildx-ecr:1.2.16
plugins/buildx-gar:1.2.16
plugins/buildx-gcr:1.2.11
plugins/buildx:1.3.0
plugins/cache:1.9.7
...
| platform.harness-manager | object | `{"affinity":{},"featureFlags":{"ADDITIONAL":""},"immutable_delegate_docker_image":{"image":{"digest":"","registry":"docker.io","repository":"harness/delegate","tag":"25.05.85801"}},"nodeSelector":{},"tolerations":{}}` | harness-manager (taints, tolerations, and so on) |
...
| platform.pipeline-service | object | `{"affinity":{},"config":{"FF_SERVER_BASE_URL":"http://ff-service.{{ .Release.Namespace }}.svc.cluster.local:16001/api/1.0"},"nodeSelector":{},"tolerations":[]}` | pipeline-service (Harness pipeline-related services) (taints, tolerations, and so on) |
