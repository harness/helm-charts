...
![Version: 0.16.0](https://img.shields.io/badge/Version-0.16.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.0.80917](https://img.shields.io/badge/AppVersion-1.0.80917-informational?style=flat-square)
...
docker.io/harness/ce-nextgen-signed:1.11.4
docker.io/harness/chaos-argoexec:v3.4.16
docker.io/harness/chaos-ddcr:1.34.0
docker.io/harness/chaos-exporter:1.34.0
docker.io/harness/chaos-go-runner-base:1.34.0
docker.io/harness/chaos-go-runner-io:1.34.0
docker.io/harness/chaos-go-runner-time:1.34.0
docker.io/harness/chaos-go-runner:1.34.0
docker.io/harness/chaos-k8s:1.34.0
docker.io/harness/chaos-log-watcher:1.34.0
docker.io/harness/chaos-machine-ifc-signed:1.34.0
docker.io/harness/chaos-machine-ifs-signed:1.34.0
docker.io/harness/chaos-operator:1.34.0
docker.io/harness/chaos-runner:1.34.0
docker.io/harness/chaos-subscriber:1.34.0
docker.io/harness/chaos-workflow-controller:v3.4.16
docker.io/harness/ci-manager-signed:1.21.5
docker.io/harness/ci-scm-signed:1.4.3
docker.io/harness/cv-nextgen-signed:1.17.0
docker.io/harness/dashboard-service-signed:1.62.3
...
docker.io/harness/delegate:24.03.82600
docker.io/harness/delegate:24.03.82600.minimal
docker.io/harness/delegate:latest
docker.io/harness/error-tracking-signed:5.35.3
docker.io/harness/et-collector-signed:5.35.0
docker.io/harness/et-receiver-signed:5.35.3
docker.io/harness/event-service-signed:1.3.1
...
docker.io/harness/gateway-signed:1.26.0
docker.io/harness/gitops-agent-installer-helper:v0.0.1
docker.io/harness/gitops-agent:v0.70.0
docker.io/harness/gitops-service-signed:1.7.2
docker.io/harness/helm-init-container:latest
docker.io/harness/k8s-chaos-infrastructure-upgrader:1.34.0
docker.io/harness/le-nextgen-signed:1.1.0
docker.io/harness/learning-engine-onprem-signed:1.1.0
docker.io/harness/litmus-checker:1.34.0
docker.io/harness/log-service-signed:1.2.0
docker.io/harness/looker-signed:23.20.39
docker.io/harness/manager-signed:1.22.9
docker.io/harness/migrator-signed:1.44.0
docker.io/harness/mongo:4.4.22
docker.io/harness/nextgenui-signed:1.14.5
docker.io/harness/ng-auth-ui-signed:1.20.0
docker.io/harness/ng-ce-ui:1.9.5
docker.io/harness/ng-dashboard-aggregator-signed:1.10.0
docker.io/harness/ng-manager-signed:1.31.4
...
docker.io/harness/smp-chaos-bg-processor-signed:1.34.5
docker.io/harness/smp-chaos-db-upgrade-agent-signed:1.34.5
docker.io/harness/smp-chaos-k8s-ifs-signed:1.34.3
docker.io/harness/smp-chaos-linux-infra-controller-signed:1.34.0
docker.io/harness/smp-chaos-linux-infra-server-signed:1.34.0
docker.io/harness/smp-chaos-manager-signed:1.34.5
docker.io/harness/smp-chaos-web-signed:1.34.5
docker.io/harness/smp-service-discovery-server-signed:0.14.6
docker.io/harness/srm-ui-signed:1.4.1
docker.io/harness/ssca-manager-signed:1.9.2
docker.io/harness/ssca-ui-signed:0.6.1
docker.io/harness/stocore-signed:1.90.1
docker.io/harness/stomanager-signed:1.20.0
docker.io/harness/telescopes-signed:1.1.0
docker.io/harness/template-service-signed:1.33.0
docker.io/harness/ti-service-signed:1.13.1
docker.io/harness/ti-service-signed:release-223
docker.io/harness/ui-signed:1.14.0
docker.io/harness/upgrader:latest
docker.io/harness/verification-service-signed:1.21.0
...
harness/ci-addon:1.16.43
harness/ci-lite-engine:1.16.26
harness/ci-lite-engine:1.16.43
...
| platform.harness-manager.featureFlags.Base | string | `"ASYNC_ARTIFACT_COLLECTION,JIRA_INTEGRATION,AUDIT_TRAIL_UI,GDS_TIME_SERIES_SAVE_PER_MINUTE,STACKDRIVER_SERVICEGUARD,TIME_SERIES_SERVICEGUARD_V2,TIME_SERIES_WORKFLOW_V2,CUSTOM_DASHBOARD,GRAPHQL,CV_FEEDBACKS,LOGS_V2_247,UPGRADE_JRE,LOG_STREAMING_INTEGRATION,NG_HARNESS_APPROVAL,GIT_SYNC_NG,NG_CG_TASK_ASSIGNMENT_ISOLATION,CI_OVERVIEW_PAGE,AZURE_CLOUD_PROVIDER_VALIDATION_ON_DELEGATE,TERRAFORM_AWS_CP_AUTHENTICATION,NG_TEMPLATES,NEW_DEPLOYMENT_FREEZE,HELM_CHART_AS_ARTIFACT,RESOLVE_DEPLOYMENT_TAGS_BEFORE_EXECUTION,WEBHOOK_TRIGGER_AUTHORIZATION,GITHUB_WEBHOOK_AUTHENTICATION,CUSTOM_MANIFEST,GIT_ACCOUNT_SUPPORT,AZURE_WEBAPP,POLLING_INTERVAL_CONFIGURABLE,APPLICATION_DROPDOWN_MULTISELECT,RESOURCE_CONSTRAINT_SCOPE_PIPELINE_ENABLED,NG_TEMPLATE_GITX,ELK_HEALTH_SOURCE,CVNG_METRIC_THRESHOLD,SRM_HOST_SAMPLING_ENABLE,SRM_ENABLE_HEALTHSOURCE_CLOUDWATCH_METRICS,CDS_SHELL_VARIABLES_EXPORT,CDS_TAS_NG,CD_TRIGGER_V2,CDS_NG_TRIGGER_MULTI_ARTIFACTS,ACCOUNT_BASIC_ROLE,PL_ENABLE_BASIC_ROLE_FOR_PROJECTS_ORGS,CD_NG_DOCKER_ARTIFACT_DIGEST,CDS_SERVICE_OVERRIDES_2_0,NG_SVC_ENV_REDESIGN,NG_EXECUTION_INPUT,CDS_SERVICENOW_REFRESH_TOKEN_AUTH,SERVICE_DASHBOARD_V2,CDS_OrgAccountLevelServiceEnvEnvGroup,CDC_SERVICE_DASHBOARD_REVAMP_NG,PL_FORCE_DELETE_CONNECTOR_SECRET,POST_PROD_ROLLBACK,PIE_STATIC_YAML_SCHEMA,SPG_SIDENAV_COLLAPSE,CI_LE_STATUS_REST_ENABLED,HOSTED_BUILDS,CIE_HOSTED_VMS,ENABLE_K8_BUILDS,CI_DISABLE_RESOURCE_OPTIMIZATION,CI_OUTPUT_VARIABLES_AS_ENV,CDS_GITHUB_APP_AUTHENTICATION,CDS_REMOVE_TIME_BUCKET_GAPFILL_QUERY,CDS_CONTAINER_STEP_GROUP,CDS_SUPPORT_EXPRESSION_REMOTE_TERRAFORM_VAR_FILES_NG,CDS_AWS_CDK,DISABLE_WINRM_COMMAND_ENCODING_NG,SKIP_ADDING_TRACK_LABEL_SELECTOR_IN_ROLLING,CDS_HTTP_STEP_NG_CERTIFICATE,ENABLE_CERT_VALIDATION,CDS_GET_SERVICENOW_STANDARD_TEMPLATE,CDS_ENABLE_NEW_PARAMETER_FIELD_PROCESSOR,SRM_MICRO_FRONTEND,CVNG_TEMPLATE_MONITORED_SERVICE,PIE_ASYNC_FILTER_CREATION,PL_DISCOVERY_ENABLE,PIE_GIT_BI_DIRECTIONAL_SYNC,CDS_METHOD_INVOCATION_NEW_FLOW_EXPRESSION_ENGINE,CD_NG_DYNAMIC_PROVISIONING_ENV_V2,CDS_HELM_MULTIPLE_MANIFEST_SUPPORT_NG,CDS_SERVERLESS_V2,CDP_AWS_SAM,CDS_IMPROVED_HELM_DEPLOYMENT_TRACKING,CDS_K8S_APPLY_MANIFEST_WITHOUT_SERVICE_NG,CDS_HELM_FETCH_CHART_METADATA_NG,CVNG_TEMPLATE_VERIFY_STEP"` | Base flags for all modules(enabled by Default) |
