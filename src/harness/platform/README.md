...
| access-control.image.tag | string | `"76401"` |  |
...
| change-data-capture.image.tag | string | `"76620"` |  |
...
| cv-nextgen.image.tag | string | `"76620"` |  |
...
| delegate-proxy.image.tag | string | `"76614"` |  |
...
| gateway.image.tag | string | `"200069"` |  |
...
| harness-manager.image.tag | string | `"76620"` |  |
...
| next-gen-ui.image.tag | string | `"0.318.6"` |  |
...
| ng-auth-ui.image.tag | string | `"0.42.0"` |  |
...
| ng-manager.image.tag | string | `"76620"` |  |
...
| pipeline-service.image.tag | string | `"1.6.0"` |  |
...
| platform-service.image.tag | string | `"76600"` |  |
...
| scm-service.image.tag | string | `"release-76-ubi"` |  |
...
| template-service.image.tag | string | `"76620"` |  |
...
| ti-service.image.tag | string | `"release-86"` |  |
...
| ti-service.jobs.migrate.image.tag | string | `"release-86"` |  |
