...
| change-data-capture.image.tag | string | `"77124"` |  |
...
| cv-nextgen.image.tag | string | `"77124"` |  |
...
| delegate-proxy.image.tag | string | `"77035"` |  |
...
| harness-manager.image.tag | string | `"77124"` |  |
...
| harness-manager.version | string | `"1.0.77124"` |  |
...
| next-gen-ui.image.tag | string | `"0.323.9"` |  |
...
| ng-manager.image.tag | string | `"77124"` |  |
...
| template-service.image.tag | string | `"77124"` |  |
