...
| access-control.image.tag | string | `"76800"` |  |
...
| change-data-capture.image.tag | string | `"77026"` |  |
...
| cv-nextgen.image.tag | string | `"77026"` |  |
...
| delegate-proxy.image.tag | string | `"76818_2"` |  |
...
| gateway.image.tag | string | `"200089"` |  |
...
| next-gen-ui.image.tag | string | `"0.322.11"` |  |
...
| platform-service.image.tag | string | `"77000"` |  |
...
| template-service.image.tag | string | `"77026"` |  |
