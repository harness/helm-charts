...
| change-data-capture.image.tag | string | `"77117"` |  |
...
| cv-nextgen.image.tag | string | `"77117"` |  |
...
| delegate-proxy.image.tag | string | `"77021"` |  |
...
| harness-manager.image.tag | string | `"77117"` |  |
...
| harness-manager.version | string | `"1.0.77117"` |  |
...
| ng-manager.image.tag | string | `"77117"` |  |
...
| template-service.image.tag | string | `"77117"` |  |
