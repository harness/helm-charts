...
files=("platform_images.tgz" "cdng_images.tgz" "ccm_images.tgz" "ce_images.tgz" "ci_images.tgz" "sto_images.tgz" "ssca_images.tgz" "dbdevops_images.tgz" "code_images.tgz" "iacm_images.txt")
